...
public class GoogleDataSegmentPusherTest extends EasyMockSupport
{
  ...
  private static final String path = "test/2015-04-12T00:00:00.000Z_2015-04-13T00:00:00.000Z/1/0/index.zip";
  ...
  public void uploadDataSegmentTest() throws IOException
  {
    ...
    final String indexPath = storageDir + "/" + "index.zip";
    final String descriptorPath = storageDir + "/" + "descriptor.json";
