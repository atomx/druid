...
public class GoogleTaskLogsTest extends EasyMockSupport {
  ...
  private static final GoogleTaskLogsConfig googleTaskLogsConfig = new GoogleTaskLogsConfig(bucket, prefix);
  ...
  public void before() {
    ...
    googleTaskLogs = new GoogleTaskLogs(googleTaskLogsConfig, storage);
  }
